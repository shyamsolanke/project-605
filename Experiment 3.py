...
# -- Experiment 3: GPU Single-GPU FP32 Setup --
print("\nInitializing Experiment 3: GPU Single-GPU FP32 Setup... \n")
...
# Test loader uses same batch, no shuffle
...
# Model & optimizer
print("Initializing ResNet-18 model and optimizer...")
...
def train_epoch(epoch):
    ...
    if enable_profiling and epoch == 1:
        print("Profiling first epoch on GPU (10 batches)...")
        ...
        prof.export_chrome_trace("profiler_exp3_trace.json")
        with open("profiler_exp3_summary.txt", "w") as f:
            f.write(summary)
...
def eval_model():
    ...
    torch.save(model.state_dict(), 'resnet18_cifar10_gpu_fp32.pth')
    print("Saved checkpoint: resnet18_cifar10_gpu_fp32.pth\n")

if __name__ == '__main__':
    for epoch in range(1, num_epochs+1):
        train_epoch(epoch)
        eval_model()
    print("All done. Experiment 3 complete.")
